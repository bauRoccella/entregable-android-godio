...
public final class PlayerDao_Impl implements PlayerDao {
  ...
  public PlayerDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlayerEntity = new EntityInsertionAdapter<PlayerEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `players` (`id`,`name`,`createdAt`) VALUES (nullif(?, 0),?,?)";
      }
  ...
  @Override
  public Object delete(final PlayerEntity player, final Continuation<? super Unit> $completion) {
      ...
      public List<PlayerEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PlayerEntity(_tmpId,_tmpName,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public PlayerEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new PlayerEntity(_tmpId,_tmpName,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
